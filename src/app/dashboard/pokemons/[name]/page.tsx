...
import { type PokemonsResponse, type Pokemon } from '@/pokemons'
...
export async function generateMetadata({ params }: PokemonPageProps): Promise<Metadata> {
  try {
    const { id, name } = await getOnePokemon(params.name)
...
const getOnePokemon = async (name: string): Promise<Pokemon> => {
  try {
